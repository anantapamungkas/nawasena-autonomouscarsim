...
# --- Parameter Sensor ---
OBSTACLE_DISTANCE_THRESHOLD = 300 # Jarak rintangan depan (cm)
...
SENSOR_STEERING_THRESHOLD = 200 # Jika sensor samping kurang dari ini, mulai koreksi kemudi
SENSOR_STEERING_GAIN = 0.05   # Seberapa kuat koreksi kemudi berdasarkan sensor
